...
export const spaces: ParkingSpace[] = [
  {
    ...
    location: {
      latitude: 40.42275,
      longitude: -86.90942,
      address: "141 Pierce St, West Lafayette, IN",
    } as Location,
    is_paid: true,
...

  {
    ...
    location: {
      latitude: 40.42168,
      longitude: -86.89832,
      address: "100 Tapawingo Dr, West Lafayette, IN",
    } as Location,
    is_paid: true,
...

  {
    ...
    location: {
      latitude: 40.42318,
      longitude: -86.90759,
      address: "157 W State St, West Lafayette, IN",
    } as Location,
    is_paid: true,
...

  {
    ...
    location: {
      latitude: 40.42517,
      longitude: -86.92742,
      address: "107 MacArthur Dr, West Lafayette, IN",
    } as Location,
    is_paid: true,
...

  {
    ...
    location: {
      latitude: 40.42082,
      longitude: -86.91086,
      address: "241 S Grant St, West Lafayette, IN",
    } as Location,
    is_paid: true,
    features: ["EV Charging", "Covered", "Security Cameras"],
    availability_schedule: [
  ...
  {
    id: "10a2b3c4d-5678-90ab-cdef-1234567890kf",
    owner_id: "a23e4567-e89b-12d3-a456-426614174009",
    location: {
      latitude: 40.431040,
      longitude: -86.913150,
      address: "605 W Stadium Ave, West Lafayette, IN",
    } as Location,
    is_paid: true,
    features: ["EV Charging", "Covered", "Security Cameras"],
    availability_schedule: [
