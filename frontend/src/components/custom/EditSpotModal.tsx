                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-2 text-slate-950">
                        ...
                        />
                        <Label
                          htmlFor={`spot-type-${spot.is_paid ? "rental" : "free"}`}
                        >
                    ...
                    {spot.is_paid && (
                      <div className="space-y-2">
                        <Label htmlFor="address" className="text-slate-950">
                          Address
                        </Label>
                        <Input
                          id="address"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="latitude" className="text-slate-950">
                          Latitude
                        </Label>
                        <Input
                          id="latitude"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="longitude" className="text-slate-950">
                          Longitude
                        </Label>
                        <Input
                          id="longitude"
                    ...
                    <div className="space-y-2">
                      ...
                      {geoEnabled ? (
                        userLocation ? (
                          ...
                          <p className="text-slate-950">
                            Your current location will be used for the spot.
                          </p>
                        )
                      ) : (
                        <p className="text-slate-950">
                          Geolocation is not enabled. Please enable location
                          services.
                        </p>
                      )}
                    </div>
      ...
      <AlertDialog open={isReverifyOpen} onOpenChange={setIsReverifyOpen}>
        ...
        <AlertDialogContent className="z-[300]">
          ...
          <AlertDialogDescription>
            ...
            reverification. This is a destructive action and will make your spot
            unavailable for new bookings until it's reverified. Do you want to
            proceed?
          </AlertDialogDescription>
          <AlertDialogFooter>
