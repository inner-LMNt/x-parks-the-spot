...
import { request_delete_account, get_notification_time, update_notification_time, set_user_location } from "@/features/user/userSlice";
                ...
                <div className="mb-8">
                    ...
                    <form onSubmit={locationHandleSubmit(handleSaveLocation)}>
                        <div className="mb-4">
                            ...
                            <select
                                id="state"
                                {...locationRegister('state', { required: 'State is required' })}
                            ...
                            {locationErrors.state && (
                                <p className="text-red-600 text-sm mt-1">{locationErrors.state.message}</p>
                            )}
                        </div>
                        <div className="mb-4">
