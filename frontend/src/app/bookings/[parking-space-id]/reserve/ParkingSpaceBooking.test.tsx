...
jest.mock("next/navigation", () => ({
  ...
  useParams: jest.fn().mockReturnValue({
    "parking-space-id": "1692f1d6-a67b-4659-a555-bdf22359bd24",
  }),
  usePathname: jest
    .fn()
    .mockReturnValue("/bookings/[parking-space-id]/reserve"),
  useSearchParams: jest
    .fn()
    .mockReturnValue(new URLSearchParams({ previousUrl: "/bookings" })),
}))
describe.skip("ParkingSpaceBooking Component", () => {
  ...
  it("renders the ParkingSpaceBooking component with parking space data and car infos", () => {
    ...
    expect(
      screen.getByRole("heading", {
        name: "3212 Deer Pointe Pl, Prospect, KY",
        level: 3,
      }),
    ).toBeInTheDocument()
  ...
  it("handles successful locking on mount", async () => {
    ...
    expect(lockParkingSpace).toHaveBeenCalledWith({
  ...
  it("unlocks parking space on unmount", () => {
    ...
    expect(unlockParkingSpace).toHaveBeenCalledWith(
