...
export default function ProfilePage() {
    ...
    // Example comments data with users, comments, and sentiment (upvote/downvote)
    const comments = [
            ...
            <div className="relative w-full max-w-md md:max-w-lg lg:max-w-xl text-center bg-white shadow-md rounded-lg p-6 md:p-8">
                ...
                <div className="flex flex-col items-center mb-4">
                    ...
                    <div className="flex justify-center items-center space-x-8">
                        <div>
                            <p className="text-lg md:text-xl font-bold">{eloRating}</p>
                            <p className="text-sm md:text-base text-gray-600">Rating</p>
                        </div>
                        <div>
                            <p className="text-lg md:text-xl font-bold">{userProfile.spotfindPosts}</p>
                            <p className="text-sm md:text-base text-gray-600">Posts</p>
                        </div>
                        <div>
                            <p className="text-lg md:text-xl font-bold">{userProfile.yearsOnApp}</p>
                ...
                <div className="text-left mb-6">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-xs text-gray-600">Top Spot</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="w-12 h-12 bg-yellow-500 rounded-full mb-2"></div>
                            <p className="text-xs text-gray-600">Quick Finder</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="w-12 h-12 bg-red-500 rounded-full mb-2"></div>
                            <p className="text-xs text-gray-600">Top Rating</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="text-left mb-6">
                    ...
                    <div className="space-y-2">
                        {comments.map((commentData, index) => (
                            <div key={index} className="bg-gray-100 p-4 rounded-lg shadow-sm flex justify-between items-start">
                                <div>
                                    <p className="text-sm font-bold text-gray-900">{commentData.user}</p>
                                    <p className="text-sm text-gray-700">{commentData.comment}</p>
                                </div>
