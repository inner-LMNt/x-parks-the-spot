...
const BookingDetailCard = ({
    ...
    const formatDuration = (duration: number, isMultiDay: boolean, daysDuration: number) => {
        if (isMultiDay) {
                        ...
                        <Card className="shadow-xl w-full overflow-hidden">
                            <CardHeader className="relative border-b">
                                ...
                                <div className="flex items-center justify-between pr-8">
                                    ...
                                    <Badge variant={getStatusBadgeVariant(booking.status, booking.time_status)}>
                                        {booking.status === 'canceled'
                                            ? 'Canceled'
                                            : booking.time_status.charAt(0).toUpperCase() + booking.time_status.slice(1)}
                                    </Badge>
                                </div>
                            </CardHeader>

                            <CardContent className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(90vh - 100px)' }}>
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {booking.rentalCount > 1 && (
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-sm">Repeat customer ({booking.rentalCount}x)</span>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-medium">
                                                Duration: {formatDuration(booking.duration, booking.isMultiDay, booking.daysDuration)}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    {/* Cancel Button */}
                                    {booking.time_status === 'upcoming' && booking.status !== 'canceled' && (
                                        <div className="pt-4">
