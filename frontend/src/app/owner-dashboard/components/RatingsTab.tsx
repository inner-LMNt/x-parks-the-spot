                          ...
                          <div className="flex flex-col gap-2">
                            <div className="space-y-1">
                              <div className="flex items-center gap-2">
                                <div className="w-8 text-xs text-gray-500">avail</div>
                                <div className="w-16 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                  <div
                                      className="h-full bg-blue-500 rounded-full"
                                      style={{width: `${(spot.availabilityRating / 5) * 100}%`}}
                                  />
                                </div>
                            ...
                            <div className="space-y-1">
                              <div className="flex items-center gap-2">
                                <div className="w-8 text-xs text-gray-500">clean</div>
                                <div className="w-16 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                  <div
                                      className="h-full bg-green-500 rounded-full"
                                      style={{width: `${(spot.cleanlinessRating / 5) * 100}%`}}
                                  />
                                </div>
                                <div className="text-xs font-medium text-slate-950">
                        ...
                        <td className="p-2.5">
                          <div className="space-y-0.5">
                            {spot.ratingDistribution
                                ...
                                .map((dist) => (
                                    <div key={dist.stars} className="flex items-center gap-1 text-xs">
                                      <div className="w-6 text-slate-950 flex items-center">
                                        {dist.stars}<Star className="w-2 h-2 fill-yellow-400 ml-0.5" strokeWidth={0}/>
                                      </div>
