        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {ratingMetrics.averageRatings.total.toFixed(1)}
            </div>
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <CardDescription>
                    {
                      spots.find((s) => s.id === spotRating.spotId)?.location
                        .address
                    }
                  </CardDescription>
                </div>
                <Badge className="flex items-center gap-1">
                  ...
                  {spotRating.totalRating === "unrated"
                    ? "Not rated"
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>
                      {spotRating.availabilityRating?.toFixed(1) || "N/A"}
                    </span>
                  </div>
                  <Progress value={spotRating.availabilityRating * 20} />
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    <span>Cleanliness</span>
                    <span>
                      {spotRating.cleanlinessRating?.toFixed(1) || "N/A"}
                    </span>
                  </div>
                  <Progress value={spotRating.cleanlinessRating * 20} />
                </div>
            ...
            {[
              {
                ...
                description:
                  "Consider adding more detailed directions in the spot description.",
                impact: "high",
              },
              {
                title: "Update availability faster",
                description:
                  "Quick updates can increase your booking rate by 15%.",
                impact: "medium",
              },
              {
