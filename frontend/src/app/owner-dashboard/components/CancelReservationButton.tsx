...
} from "@/features/owner-reservations/reservationCancellationSlice"
      ...
      <AlertDialogContent className="w-96 bg-white text-slate-950 rounded-lg">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="mt-4 text-sm text-slate-700">
            Are you sure you want to forcefully cancel this reservation? This
            action cannot be undone. The renter will be alerted of this
