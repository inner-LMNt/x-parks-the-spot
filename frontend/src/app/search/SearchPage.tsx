  ...
  const enableGeolocation = (
    <div className="p-4 bg-gray-100 rounded-md">
      <p className="text-lg font-semibold mb-2">
        Please enable geolocation to search for parking spots near you.
      </p>
  ...
  return (
    domLoaded && (
      ...
      >
        ...
        {showLoginModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="mb-4">
                Please log in to continue reserving a parking spot.
              </p>
        ...
        >
          <Card
            className={`w-3/4 sm:w-2/3 md:w-1/2 lg:w-2/5 max-h-[50vh] overflow-y-auto`}
          >
            <CardHeader
            ...
            >
              {geoEnabled ? (
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center mb-4">
                      <input
                        ...
                        className="mr-2"
                      />
                      <Label htmlFor="use-current-location" className="text-sm">
                    ...
                    {selectedFilters.includes("minPrice") && (
                      <div className="flex flex-col mb-4">
                        <Label htmlFor="min_price" className="text-sm mb-1">
                          Min Price:
                        </Label>
                        <Input
                          id="min_price"
                    ...
                    {selectedFilters.includes("maxPrice") && (
                      <div className="flex flex-col mb-4">
                        <Label htmlFor="max_price" className="text-sm mb-1">
                          Max Price:
                        </Label>
                        <Input
                          id="max_price"
                    ...
                    {selectedFilters.includes("startTime") && (
                      <div className="flex flex-col mb-4">
                        <Label htmlFor="start_time" className="text-sm mb-1">
                          Start Time:
                        </Label>
                        <Input
                          id="start_time"
                    ...
                    {selectedFilters.includes("endTime") && (
                      <div className="flex flex-col mb-4">
                        <Label htmlFor="end_time" className="text-sm mb-1">
                          End Time:
                        </Label>
                        <Input
                          id="end_time"
                    ...
                    {selectedFilters.includes("paidStatus") && (
                      <div className="flex flex-col mb-4">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Select both or none for no restriction.
                        </p>
                      </div>
                    )}
                    ...
                    <div className="flex flex-col mb-4">
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) =>
                            setIncludeTakenSpots(e.target.checked)
                          }
                          className="mr-2"
                        />
                        <Label htmlFor="include_taken" className="text-sm">
                          Include Taken Spots
                        </Label>
                      </div>
                    </div>
                ...
                <CardContent className="pt-2">
                  <div className="p-4 bg-gray-100 rounded-md">
                    <p className="text-lg font-semibold mb-2">
                      Please enable geolocation to search for parking spots near
                      you.
                    </p>
                    <p className="mb-2">To enable geolocation:</p>
                    <ol className="list-decimal list-inside ml-4">
                      ...
                      <li className="mb-1">
                        Reload the page after enabling it.
                      </li>
                    </ol>
                  </div>
                </CardContent>
                ...
                <>
                  ...
                  >
                    <div className="w-56 p-1 text-xs">
                      ...
                      <p className="truncate text-gray-600 text-[10px] mb-1">
                        📍 {selectedSpot.location.address || "No Address Found"}
                      </p>
                      <p className="text-gray-500 text-[10px] mb-1">
                        {selectedSpot.location.latitude.toFixed(4)},{" "}
                        {selectedSpot.location.longitude.toFixed(4)}
                      </p>
                          ...
                          {!selectedSpot.is_paid && !selectedSpot.is_taken && (
                            <div className="flex gap-1 mt-2 justify-center">
                              <Button
                                onClick={() =>
                                  selectedSpot.id &&
                                  openUpdateStatusDialog(selectedSpot.id)
                                }
                              >
                                Update Spot Status
                              </Button>
                          ...
                          <DialogContent className="bg-white p-6 rounded-lg shadow-lg w-full">
                            ...
                            {isWithinDistance() ? (
                              ...
                              <div className="mt-4 text-center text-red-500 font-semibold">
                                You are too far away from the parking spot to
                                upload a verification photo.
                                <p className="text-sm mt-2">
                                  Move closer to the spot and try again.
                                </p>
                              </div>
                            )}
                          </DialogContent>
          ...
          <div className="mx-auto max-w-xl p-4">
            {!Array.isArray(parkingSpots) || parkingSpots?.length === 0 ? (
              <p className="text-center text-gray-500">
                No parking spots found. Try searching.
              </p>
            ) : (
                        ...
                        <>
                          ...
                          {isAvailable247(spot.availability_schedule) ? (
                            ...
                            <div className="flex items-center flex-wrap mt-2">
                              ...
                              {getAvailableDays(spot.availability_schedule).map(
                                (day) => (
                                  <Badge
                                    key={day}
                                    className="mr-1 mb-1"
                              ...
                              <div className="flex">
                                ...
                                <p className="text-md ml-2">
                                  {getTimeRange(spot.availability_schedule)}
                                </p>
                              </div>
                            </div>
                          )}
                          <p className="text-md">
                            Address: {spot.location.address || "Not specified"}
                          </p>
