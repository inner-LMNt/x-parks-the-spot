                    ...
                    <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                      {spot.photos && spot.photos.length > 0 && (
                        <div
                          ...
                          onClick={() => handleImageClick(spot.photos[0])}
                        >
                          <ImageWrapper
                            src={spot.photos[0]}
                      ...
                      <CardHeader className="bg-gray-50">
                        ...
                        <CardDescription>
                          <p>
                            ...
                            {spot.owner_name || "owner name not available"}
                          </p>
                          <p>
                            <strong>Owner Email:</strong>{" "}
                            {spot.owner_email || "owner email not available"}
                          </p>
                          <p>
                            <strong>Address:</strong>{" "}
                            {spot.address || "Location not available"}
                          </p>
                          <p>
                            <strong>Latitude:</strong>{" "}
                            {spot.latitude ?? "Latitude not available"}
                          </p>
                          <p>
                            <strong>Longitude:</strong>{" "}
                            {spot.longitude ?? "Longitude not available"}
                          </p>
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="pt-4">
                        {spot.verification_photos &&
                          spot.verification_photos.length > 0 && (
                            <Button
                              variant="secondary"
                              size="sm"
        ...
        >
          <DialogContent>
            ...
            <div className="grid grid-cols-1 gap-4">
              {selectedSpot.verification_photos?.map(
