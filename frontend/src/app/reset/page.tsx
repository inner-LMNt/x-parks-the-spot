...
export default function ForgotPasswordPage() {
  ...
  const onSubmit = async (data: ForgotPasswordInputs) => {
    try {
      ...
      // Open the dialog after successful submission
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 p-4">
      ...
      <motion.div variants={formVariants} initial="hidden" animate="visible">
        <Card className="w-[350px] shadow-2xl bg-white border border-gray-200 rounded-lg">
        ...
        <AlertDialogContent className="bg-white shadow-lg rounded-lg p-6">
            <AlertDialogHeader>
            <AlertDialogTitle className="text-lg text-purple-700 font-bold">Password Reset Requested</AlertDialogTitle> {/* Updated Color */}
