          ...
          <Card className="w-[90vw] shadow-2xl backdrop-blur-sm bg-white/90">
            ...
            <CardFooter>
              <motion.div variants={itemVariants} className="w-full">
                <Link href="/reset" passHref>
                  <Button
                    variant="link"
                    className="w-36 text-sm text-gray-600 hover:text-gray-800"
                  >
                    Forgot password?
                  </Button>
                </Link>
            ...
            <CardFooter>
              <motion.div
                ...
                className="w-full flex justify-center align-baseline"
              >
                <Link
                  href="/search"
                  passHref
                  className="flex justify-center hover:text-gray-800"
                >
                  <Button variant="link" className="text-sm text-gray-600 flex">
                    Continue without logging in{" "}
                    <ArrowRight className="w-4 h-4 ml-2 text-sm text-gray-600" />
                  </Button>
                </Link>
              </motion.div>
            </CardFooter>
