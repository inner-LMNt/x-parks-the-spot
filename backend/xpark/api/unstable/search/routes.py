...
def search_parking_spaces_route() -> Tuple[Any, int]:
    ...
    available_from = data.get('available_from')  # Expected in ISO format e.g., "2024-10-10T08:00:00Z"
    ...
    if available_from:
        try:
            ...
            return jsonify({'error': 'available_from must be a valid ISO 8601 datetime string'}), 400
    ...
    if available_to:
        try:
            ...
            return jsonify({'error': 'available_to must be a valid ISO 8601 datetime string'}), 400
