...
@bp.patch("<car_id>")
@require_logged_in_user
def update_car_info_route(car_id: str, token: str, user_id: uuid.UUID) -> Tuple[Any, int]:
    """
...
@bp.delete("<car_id>")
@require_logged_in_user
def delete_car_info_route(car_id: str, token: str, user_id: uuid.UUID) -> Tuple[Any, int]:
    """
    Delete a car.
    """
    try:
