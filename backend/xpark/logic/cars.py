...
def add_car_info(user_id: uuid.UUID, data: Dict[str, Any]) -> Result[Dict[str, Any], str]:
    """
...
def update_car_info_logic(user_id: uuid.UUID, car_id: uuid.UUID, updates: Dict[str, Any]) -> Result[Dict[str, Any], str]:
    """
